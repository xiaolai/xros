...
You are reasoning about the spec the user names, whose check is `soundness: none`
...
a fast model for the legwork (premise checks, extraction) and the strongest tier you have for
